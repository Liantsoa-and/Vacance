...
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE REPARATION_DEGAT CASCADE CONSTRAINTS';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE PRECIPITATION CASCADE CONSTRAINTS';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE MATERIAU_PRECIPITATION CASCADE CONSTRAINTS';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE BORNE CASCADE CONSTRAINTS';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SEQ_REPARATION_DEGAT';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SEQ_PRECIPITATION';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SEQ_MATERIAU_PRECIPITATION';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SEQ_BORNE';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
...
CREATE SEQUENCE SEQ_REPARATION_DEGAT START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE SEQ_PRECIPITATION START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE SEQ_MATERIAU_PRECIPITATION START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE SEQ_BORNE START WITH 1 INCREMENT BY 1 NOCACHE;
...
-- Table des Relations Matériau-Précipitation
...
-- Table des Bornes Kilométriques
CREATE TABLE BORNE (
    id NUMBER PRIMARY KEY,
    chemin_id NUMBER NOT NULL REFERENCES CHEMIN(id),
